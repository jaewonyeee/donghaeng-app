...
const useBarPath = (points, chartBounds, innerPadding = 0.2, roundedCorners, customBarWidth, barCount) => {
    ...
    const path = React.useMemo(() => {
        ...
        const hasNegativeYValues = points.some(({ yValue }) => yValue && yValue < 0);
        points.forEach(({ x, y, yValue }) => {
            ...
            if (roundedCorners) {
                const nonUniformRoundedRect = (0, createRoundedRectPath_1.createRoundedRectPath)(x, y, barWidth, barHeight, roundedCorners, Number(yValue));
